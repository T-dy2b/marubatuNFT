...
export default function Post() {
  ...
  const headers = {
    ...
    "X-API-KEY":
      "GARDEN", //NFTGardenで作成したAPIコードを入れる。
  };
  // --------------------------------------------------------------------------------
  ...
  const sendDataToAPI = () => {
    ...
    axios
      .post(
        ...
        {
          contract_address: "0x", // NFTのコレクションがあるコントラクトアドレスを入れる。
          blockchain: blockchain,
          sender_wallet_address: "0x", // NFTGardenで接続しているウォレットのコントラクトアドレスを入れる。
          receiver_wallet_address: receiver_wallet_address,
          metadata: [
            {
              title:
                "sudoku_Ver4", // customize NFT title
              description:
                "sudoku_Ver4", // customize NFT description
              file_fields: [
                {
                  key: "image", // customize property for NFT
                  url: "https://nft-garden-store-prod.s3-ap-northeast-1.amazonaws.com/uploads/upload_images/743c8cf6-0d51-423f-adc8-279f838e52b0/14661e8c-1d4f-5766-b773-c92cd85ac410/6f6b6be83bfd412ea4612a7d19d9b896.png", // customize property for NFT
                },
              ],
            },
          ],
